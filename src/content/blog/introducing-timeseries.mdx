...
Here is the minimal architecture of the system:
...
![Soak chart showing sustained ingestion rate over time](./introducing-timeseries/img/soak_chart.png)
...
![Cold vs warm query latency by number of series scanned](./introducing-timeseries/img/query-latency-bar-chart.png)
...
OpenData Timeseries replaces the half-dozen services, quorum replication, and shard management of a traditional timeseries database stack with one write server, zero or more read replicas and an object store bucket. That is a meaningful reduction in operational complexity, and it comes with attractive economics: you can monitor 3.9 million active series for about $200/month of compute.
