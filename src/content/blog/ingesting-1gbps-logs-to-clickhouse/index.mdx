---
title: "Ingesting 1Gbps of logs to ClickHouse for $180/mo"
description: "New pipelined producer and consumer clients for OpenData Buffer, plus a ClickHouse integration with aligned batch deduplication, move 1.1 Gbps of logs from an OTel Gateway to ClickHouse via S3 for $180/mo."
date: 2026-05-28
author: "Apurva Mehta"
...
| Throughput | 1.1 Gbps |
| --- | --- |
| p50 E2E Latency | ~2.8s |
| p99 E2E Latency | ~10s |
| Monthly Cost (S3) | $180 |
| Producer/Consumer Nodes | 2x (4vCPU + 8GB RAM) |
